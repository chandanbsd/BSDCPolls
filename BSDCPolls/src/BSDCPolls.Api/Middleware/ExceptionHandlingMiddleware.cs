...
/// <summary>
/// Catches unhandled exceptions inside the internal API and writes a structured
/// <see cref="ApiErrorResponse"/> JSON body. The BFF propagates the trace ID
/// so the Angular client can correlate errors end-to-end.
/// </summary>
