...
namespace BSDCPolls.Api.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupabaseUserId = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedOn = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PushedAt = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    Uid = table.Column<Guid>(type: "uuid", nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "invite_allowlist_entries");

            migrationBuilder.DropTable(name: "notifications");

            migrationBuilder.DropTable(name: "poll_submissions");

            migrationBuilder.DropTable(name: "survey_documents");

            migrationBuilder.DropTable(name: "user_privacy_settings");

            migrationBuilder.DropTable(name: "username_history");

            migrationBuilder.DropTable(name: "invitations");

            migrationBuilder.DropTable(name: "poll_answer_options");
            ...
            migrationBuilder.DropTable(name: "application_users");
        }
    }
}
