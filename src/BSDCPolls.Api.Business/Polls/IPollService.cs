...
public interface IPollService
{
    ...
    Task<PollDetailResponse> CreateAsync(
    ...
    Task<PollDetailResponse> GetByUidAsync(
        Guid uid,
    ...
    Task<PollQuestionResponse> PushQuestionAsync(
        Guid pollUid,
        Guid questionUid,
        int creatorId,
        CancellationToken ct = default
    ...
    Task<PollDetailResponse> ChangeStatusAsync(
        Guid pollUid,
    ...
    /// </summary>
    Task<PollSubmissionResponse> SubmitVoteAsync(
        Guid pollUid,
    ...
    Task<PollResultsResponse> GetResultsAsync(
        Guid pollUid,
        int requestingUserId,
        CancellationToken ct = default
    );
